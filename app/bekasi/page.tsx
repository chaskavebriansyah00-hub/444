...
const pageUrl = `${siteUrl}/bekasi`;

const metaDescription =
  'Jasa service AC Bekasi profesional untuk rumah, apartemen, kantor, ruko, dan tempat usaha. Melayani cuci AC, perbaikan AC, isi dan tambah freon, bongkar pasang, serta perawatan AC dengan teknisi berpengalaman, harga transparan, dan garansi 30 hari.';

export const metadata: Metadata = {
  title:
    'Jasa Service AC Bekasi Profesional & Bergaransi | Dokter Sejuk AC',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Teknisi Dokter Sejuk AC sedang service unit AC di Bekasi',
      },
    ],
  },
...
const localBusinessLd = {
  ...
  name: 'Dokter Sejuk AC — Service AC Bekasi',
  url: pageUrl,
...
const serviceLd = {
  ...
  offers: {
    '@type': 'OfferCatalog',
    name: 'Layanan Service AC Bekasi',
...
const faqLd = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Apakah Dokter Sejuk AC melayani service AC di Bekasi?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Bekasi dan sekitarnya.',
      },
    },
    {
      '@type': 'Question',
      name: 'Apa saja layanan service AC yang tersedia di Bekasi?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Apakah tersedia layanan cuci AC di Bekasi?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani cuci AC untuk berbagai kebutuhan di Bekasi.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Wilayah Bekasi mana saja yang dilayani?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Kami melayani Bekasi Selatan, Bekasi Timur, Bekasi Barat, Bekasi Utara, Medan Satria, Rawalumbu, Jatiasih, Pondok Gede, Pondok Melati, Jatisampurna, Mustika Jaya, Bantar Gebang, dan area sekitarnya.',
      },
    },
  ],
};
...
const faqItems = [
  {
    question: 'Apakah Dokter Sejuk AC melayani service AC di Bekasi?',
    answer:
      'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Bekasi dan sekitarnya.',
  },
  {
    question: 'Apa saja layanan service AC yang tersedia di Bekasi?',
    answer:
      'Cuci AC, isi dan tambah freon, perbaikan AC, AC tidak dingin, AC bocor, bongkar pasang, serta perawatan AC.',
  },
  {
    question: 'Apakah tersedia layanan cuci AC di Bekasi?',
    answer:
      'Ya. Dokter Sejuk AC melayani cuci AC untuk berbagai kebutuhan di Bekasi.',
  },
  {
  ...
  {
    question: 'Wilayah Bekasi mana saja yang dilayani?',
    answer:
      'Kami melayani Bekasi Selatan, Bekasi Timur, Bekasi Barat, Bekasi Utara, Medan Satria, Rawalumbu, Jatiasih, Pondok Gede, Pondok Melati, Jatisampurna, Mustika Jaya, Bantar Gebang, dan area sekitarnya.',
  },
];
  ...
  return (
    <>
      ...
      <main>
        <AreaHero
          city="Bekasi"
          description="Jasa service AC Bekasi profesional untuk rumah, apartemen, kantor, ruko, dan tempat usaha. Dokter Sejuk AC melayani cuci AC, perbaikan AC, isi dan tambah freon, bongkar pasang, serta perawatan AC dengan teknisi berpengalaman, harga transparan, dan pengerjaan rapi."
        />
          ...
          <div className="container-page relative z-10">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-5 font-display text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
                Pertanyaan seputar service AC Bekasi
              </h2>
