...
const pageUrl = `${siteUrl}/jakarta-pusat`;

const metaDescription =
  'Jasa service AC Jakarta Pusat profesional untuk rumah, apartemen, kantor, ruko, dan tempat usaha. Melayani cuci AC, perbaikan AC, isi dan tambah freon, bongkar pasang, serta perawatan AC dengan teknisi berpengalaman, harga transparan, dan garansi.';

export const metadata: Metadata = {
  title:
    'Jasa Service AC Jakarta Pusat Profesional & Bergaransi | Dokter Sejuk AC',

  description: metaDescription,

  keywords: [
    'service AC Jakarta Pusat',
    'jasa service AC Jakarta Pusat',
    'cuci AC Jakarta Pusat',
    'isi freon Jakarta Pusat',
    'bongkar pasang AC Jakarta Pusat',
    'perbaikan AC Jakarta Pusat',
    'teknisi AC Jakarta Pusat',
    'Dokter Sejuk AC Jakarta Pusat',
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Teknisi Dokter Sejuk AC sedang service unit AC di Jakarta Pusat',
      },
    ],
  },
...
const localBusinessLd = {
  ...
  name: 'Dokter Sejuk AC — Service AC Jakarta Pusat',
  url: pageUrl,
...
const serviceLd = {
  ...
  serviceType: 'Service AC Jakarta Pusat',
  ...
  offers: {
    '@type': 'OfferCatalog',
    name: 'Layanan Service AC Jakarta Pusat',
...
const faqLd = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Apakah Dokter Sejuk AC melayani service AC di Jakarta Pusat?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Jakarta Pusat dan sekitarnya.',
      },
    },
    {
      '@type': 'Question',
      name: 'Apa saja layanan service AC yang tersedia di Jakarta Pusat?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Apakah tersedia layanan cuci AC di Jakarta Pusat?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani cuci AC untuk berbagai kebutuhan di Jakarta Pusat.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Wilayah Jakarta Pusat mana saja yang dilayani?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Kami melayani Tanah Abang, Menteng, Senen, Johar Baru, Cempaka Putih, Kemayoran, Sawah Besar, Gambir, dan area sekitarnya.',
      },
    },
  ],
};
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Service AC Jakarta Pusat',
      item: pageUrl,
    },
  ],
};

const jakartaPusatFaq = [
  {
    question:
      'Apakah Dokter Sejuk AC melayani service AC di Jakarta Pusat?',
    answer:
      'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Jakarta Pusat dan sekitarnya.',
  },
  {
    question:
      'Apa saja layanan service AC yang tersedia di Jakarta Pusat?',
    answer:
      'Kami melayani cuci AC, perbaikan AC, AC tidak dingin, AC bocor, isi freon, tambah freon, bongkar pasang AC, pemasangan AC, dan perawatan AC di Jakarta Pusat.',
  },
  {
    question: 'Berapa harga cuci AC di Jakarta Pusat?',
    answer:
  ...
  {
    question:
      'Apakah Dokter Sejuk menangani AC yang tidak dingin di Jakarta Pusat?',
    answer:
  ...
  {
    question:
      'Apakah tersedia layanan isi dan tambah freon di Jakarta Pusat?',
    answer:
      'Ya. Layanan isi dan tambah freon tersedia di Jakarta Pusat. Teknisi akan melakukan pengecekan kondisi sistem AC terlebih dahulu sebelum menentukan tindakan yang diperlukan.',
  },
  {
    question:
      'Apakah service AC di Jakarta Pusat mendapatkan garansi?',
    answer:
      'Ya. Layanan tertentu mendapatkan garansi 30 hari sesuai ketentuan layanan yang berlaku.',
  },
  {
    question: 'Wilayah Jakarta Pusat mana saja yang dilayani?',
    answer:
      'Kami melayani Tanah Abang, Menteng, Senen, Johar Baru, Cempaka Putih, Kemayoran, Sawah Besar, Gambir, dan area sekitarnya.',
  },
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <AreaHero
          city="Jakarta Pusat"
          description="Jasa service AC Jakarta Pusat profesional untuk rumah, apartemen, kantor, ruko, dan tempat usaha. Dokter Sejuk AC melayani cuci AC, perbaikan AC, isi dan tambah freon, bongkar pasang, serta perawatan AC dengan teknisi berpengalaman, harga transparan, dan pengerjaan rapi."
        />
          ...
          <div className="container-page relative z-10">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-5 font-display text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
                Pertanyaan Seputar Service AC Jakarta Pusat
              </h2>
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/85 sm:text-base lg:text-lg">
                ...
                wilayah service AC Dokter Sejuk AC di Jakarta Pusat.
              </p>
            </div>

            {/* FAQ */}
            <div className="mx-auto mt-10 max-w-4xl space-y-4 sm:mt-12">
              {jakartaPusatFaq.map((item) => (
                <details
                  key={item.question}
