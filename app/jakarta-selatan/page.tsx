...
import { SelatanHero } from '@/components/jakarta-selatan/selatan-hero';
...
const pageUrl = `${siteUrl}/jakarta-selatan`;

const metaDescription =
  'Jasa service AC Jakarta Selatan untuk cuci AC, isi freon, perbaikan, bongkar pasang, dan perawatan AC. Teknisi berpengalaman, harga transparan, dan layanan bergaransi.';

export const metadata: Metadata = {
  title:
    'Jasa Service AC Jakarta Selatan Profesional & Bergaransi | Dokter Sejuk AC',

  description: metaDescription,

  keywords: [
    'service AC Jakarta Selatan',
    'jasa service AC Jakarta Selatan',
    'cuci AC Jakarta Selatan',
    'isi freon Jakarta Selatan',
    'bongkar pasang AC Jakarta Selatan',
    'perbaikan AC Jakarta Selatan',
    'teknisi AC Jakarta Selatan',
    'Dokter Sejuk AC Jakarta Selatan',
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Teknisi Dokter Sejuk AC sedang service unit AC di Jakarta Selatan',
      },
    ],
  },
...
const localBusinessLd = {
  ...
  name: 'Dokter Sejuk AC — Service AC Jakarta Selatan',
  url: pageUrl,
...
const serviceLd = {
  ...
  serviceType: 'Service AC Jakarta Selatan',
  ...
  offers: {
    '@type': 'OfferCatalog',
    name: 'Layanan Service AC Jakarta Selatan',
...
const faqLd = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Apakah Dokter Sejuk AC melayani service AC di Jakarta Selatan?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Jakarta Selatan dan sekitarnya.',
      },
    },
    {
      '@type': 'Question',
      name: 'Apa saja layanan service AC yang tersedia di Jakarta Selatan?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Kami melayani cuci AC, perbaikan AC, AC tidak dingin, AC bocor, isi freon, tambah freon, bongkar pasang AC, pemasangan AC, dan perawatan AC di Jakarta Selatan.',
      },
    },
    {
      '@type': 'Question',
      name: 'Berapa harga cuci AC di Jakarta Selatan?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Apakah Dokter Sejuk menangani AC yang tidak dingin di Jakarta Selatan?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Apakah tersedia layanan isi dan tambah freon di Jakarta Selatan?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Layanan isi dan tambah freon tersedia di Jakarta Selatan. Teknisi akan melakukan pengecekan kondisi sistem AC terlebih dahulu sebelum menentukan tindakan yang diperlukan.',
      },
    },
    {
      '@type': 'Question',
      name: 'Apakah service AC di Jakarta Selatan mendapatkan garansi?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Beberapa layanan mendapatkan garansi sesuai ketentuan layanan yang berlaku.',
      },
    },
    {
      '@type': 'Question',
      name: 'Wilayah Jakarta Selatan mana saja yang dilayani?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Kami melayani Kebayoran Baru, Kebayoran Lama, Pesanggrahan, Cilandak, Jagakarsa, Mampang Prapatan, Pancoran, Tebet, Pasar Minggu, Setiabudi, dan area sekitarnya.',
      },
    },
  ],
};
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Service AC Jakarta Selatan',
      item: pageUrl,
    },
  ],
};

const jakartaSelatanFaq = [
  {
    question:
      'Apakah Dokter Sejuk AC melayani service AC di Jakarta Selatan?',
    answer:
  ...
  {
    question:
      'Apa saja layanan service AC yang tersedia di Jakarta Selatan?',
    answer:
      'Kami melayani cuci AC, perbaikan AC, AC tidak dingin, AC bocor, isi freon, tambah freon, bongkar pasang AC, pemasangan AC, dan perawatan AC di Jakarta Selatan.',
  },
  {
    question: 'Berapa harga cuci AC di Jakarta Selatan?',
    answer:
  ...
  {
    question:
      'Apakah Dokter Sejuk menangani AC yang tidak dingin di Jakarta Selatan?',
    answer:
  ...
  {
    question:
      'Apakah tersedia layanan isi dan tambah freon di Jakarta Selatan?',
    answer:
      'Ya. Layanan isi dan tambah freon tersedia di Jakarta Selatan. Teknisi akan melakukan pengecekan kondisi sistem AC terlebih dahulu sebelum menentukan tindakan yang diperlukan.',
  },
  {
    question:
      'Apakah service AC di Jakarta Selatan mendapatkan garansi?',
    answer:
          ...
          <div className="container-page relative z-10">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-5 font-display text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
                Pertanyaan Seputar Service AC Jakarta Selatan
              </h2>
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/85 sm:text-base lg:text-lg">
                ...
                wilayah service AC Dokter Sejuk AC di Jakarta Selatan.
              </p>
            </div>

            {/* FAQ */}
            <div className="mx-auto mt-10 max-w-4xl space-y-4 sm:mt-12">
              {jakartaSelatanFaq.map((item) => (
                <details
                  key={item.question}
