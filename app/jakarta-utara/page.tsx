...
const pageUrl = `${siteUrl}/jakarta-utara`;

const metaDescription =
  'Jasa service AC Jakarta Utara profesional untuk rumah, apartemen, kantor, ruko, dan tempat usaha. Melayani cuci AC, perbaikan AC, isi dan tambah freon, bongkar pasang, serta perawatan AC dengan teknisi berpengalaman, harga transparan, dan garansi.';

export const metadata: Metadata = {
  title:
    'Jasa Service AC Jakarta Utara Profesional & Bergaransi | Dokter Sejuk AC',

  description: metaDescription,

  keywords: [
    'service AC Jakarta Utara',
    'jasa service AC Jakarta Utara',
    'cuci AC Jakarta Utara',
    'isi freon Jakarta Utara',
    'bongkar pasang AC Jakarta Utara',
    'perbaikan AC Jakarta Utara',
    'teknisi AC Jakarta Utara',
    'Dokter Sejuk AC Jakarta Utara',
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Teknisi Dokter Sejuk AC sedang service unit AC di Jakarta Utara',
      },
    ],
  },
...
const localBusinessLd = {
  ...
  name: 'Dokter Sejuk AC — Service AC Jakarta Utara',
  url: pageUrl,
...
const serviceLd = {
  ...
  serviceType: 'Service AC Jakarta Utara',
  ...
  offers: {
    '@type': 'OfferCatalog',
    name: 'Layanan Service AC Jakarta Utara',
...
const faqLd = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Apakah Dokter Sejuk AC melayani service AC di Jakarta Utara?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Jakarta Utara dan sekitarnya.',
      },
    },
    {
      '@type': 'Question',
      name: 'Apa saja layanan service AC yang tersedia di Jakarta Utara?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Apakah tersedia layanan cuci AC di Jakarta Utara?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani cuci AC untuk berbagai kebutuhan di Jakarta Utara.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Wilayah Jakarta Utara mana saja yang dilayani?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Kami melayani Penjaringan, Pademangan, Tanjung Priok, Koja, Kelapa Gading, Cilincing, dan area sekitarnya.',
      },
    },
  ],
};
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Service AC Jakarta Utara',
      item: pageUrl,
    },
  ],
};

const jakartaUtaraFaq = [
  {
    question:
      'Apakah Dokter Sejuk AC melayani service AC di Jakarta Utara?',
    answer:
      'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Jakarta Utara dan sekitarnya.',
  },
  {
    question:
      'Apa saja layanan service AC yang tersedia di Jakarta Utara?',
    answer:
      'Kami melayani cuci AC, perbaikan AC, AC tidak dingin, AC bocor, isi freon, tambah freon, bongkar pasang AC, pemasangan AC, dan perawatan AC di Jakarta Utara.',
  },
  {
    question: 'Berapa harga cuci AC di Jakarta Utara?',
    answer:
  ...
  {
    question:
      'Apakah Dokter Sejuk menangani AC yang tidak dingin di Jakarta Utara?',
    answer:
  ...
  {
    question:
      'Apakah tersedia layanan isi dan tambah freon di Jakarta Utara?',
    answer:
      'Ya. Layanan isi dan tambah freon tersedia di Jakarta Utara. Teknisi akan melakukan pengecekan kondisi sistem AC terlebih dahulu sebelum menentukan tindakan yang diperlukan.',
  },
  {
    question:
      'Apakah service AC di Jakarta Utara mendapatkan garansi?',
    answer:
      'Ya. Layanan tertentu mendapatkan garansi 30 hari sesuai ketentuan layanan yang berlaku.',
  },
  {
    question: 'Wilayah Jakarta Utara mana saja yang dilayani?',
    answer:
      'Kami melayani Penjaringan, Pademangan, Tanjung Priok, Koja, Kelapa Gading, Cilincing, dan area sekitarnya.',
  },
];
  ...
  return (
    <>
      ...
      <main>
        ...
        <AreaHero
          city="Jakarta Utara"
          description="Jasa service AC Jakarta Utara profesional untuk rumah, apartemen, kantor, ruko, dan tempat usaha. Dokter Sejuk AC melayani cuci AC, perbaikan AC, isi dan tambah freon, bongkar pasang, serta perawatan AC dengan teknisi berpengalaman, harga transparan, dan pengerjaan rapi."
        />
          ...
          <div className="container-page relative z-10">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-5 font-display text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
                Pertanyaan Seputar Service AC Jakarta Utara
              </h2>
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/85 sm:text-base lg:text-lg">
                ...
                wilayah service AC Dokter Sejuk AC di Jakarta Utara.
              </p>
            </div>

            {/* FAQ */}
            <div className="mx-auto mt-10 max-w-4xl space-y-4 sm:mt-12">
              {jakartaUtaraFaq.map((item) => (
                <details
                  key={item.question}
