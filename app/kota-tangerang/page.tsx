...
const pageUrl = `${siteUrl}/kota-tangerang`;

const metaDescription =
  'Jasa service AC Kota Tangerang profesional untuk rumah, apartemen, kantor, ruko, dan tempat usaha. Melayani cuci AC, perbaikan AC, isi dan tambah freon, bongkar pasang, serta perawatan AC dengan teknisi berpengalaman, harga transparan, dan garansi 30 hari.';

export const metadata: Metadata = {
  title:
    'Jasa Service AC Kota Tangerang Profesional & Bergaransi | Dokter Sejuk AC',

  description: metaDescription,

  keywords: [
    'service AC Kota Tangerang',
    'jasa service AC Kota Tangerang',
    'cuci AC Kota Tangerang',
    'isi freon Kota Tangerang',
    'bongkar pasang AC Kota Tangerang',
    'perbaikan AC Kota Tangerang',
    'teknisi AC Kota Tangerang',
    'Dokter Sejuk AC Kota Tangerang',
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Teknisi Dokter Sejuk AC sedang service unit AC di Kota Tangerang',
      },
    ],
  },
...
const localBusinessLd = {
  ...
  name: 'Dokter Sejuk AC — Service AC Kota Tangerang',
  url: pageUrl,
...
const serviceLd = {
  ...
  serviceType: 'Service AC Kota Tangerang',
  ...
  offers: {
    '@type': 'OfferCatalog',
    name: 'Layanan Service AC Kota Tangerang',
...
const faqLd = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Apakah Dokter Sejuk AC melayani service AC di Kota Tangerang?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Kota Tangerang dan sekitarnya.',
      },
    },
    {
      '@type': 'Question',
      name: 'Apa saja layanan service AC yang tersedia di Kota Tangerang?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Apakah tersedia layanan cuci AC di Kota Tangerang?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani cuci AC untuk berbagai kebutuhan di Kota Tangerang.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Wilayah Kota Tangerang mana saja yang dilayani?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Kami melayani Tangerang, Karawaci, Cibodas, Jatiuwung, Periuk, Neglasari, Batuceper, Benda, Cipondoh, Pinang, Tangerang Kota, dan area sekitarnya.',
      },
    },
  ],
};
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Service AC Kota Tangerang',
      item: pageUrl,
    },
  ],
};

const kotaTangerangFaq = [
  {
    question: 'Apakah Dokter Sejuk AC melayani service AC di Kota Tangerang?',
    answer:
      'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Kota Tangerang dan sekitarnya.',
  },
  {
    question:
      'Apa saja layanan service AC yang tersedia di Kota Tangerang?',
    answer:
      'Cuci AC, isi dan tambah freon, perbaikan AC, AC tidak dingin, AC bocor, bongkar pasang, serta perawatan AC.',
  },
  {
    question: 'Apakah tersedia layanan cuci AC di Kota Tangerang?',
    answer:
      'Ya. Dokter Sejuk AC melayani cuci AC untuk berbagai kebutuhan di Kota Tangerang.',
  },
  {
  ...
  {
    question: 'Wilayah Kota Tangerang mana saja yang dilayani?',
    answer:
      'Kami melayani Tangerang, Karawaci, Cibodas, Jatiuwung, Periuk, Neglasari, Batuceper, Benda, Cipondoh, Pinang, Tangerang Kota, dan area sekitarnya.',
  },
];

export default function KotaTangerangPage() {
  return (
    <>
      <script
      ...
      <main>
        ...
        <AreaHero
          city="Kota Tangerang"
          description="Jasa service AC Kota Tangerang profesional untuk rumah, apartemen, kantor, ruko, dan tempat usaha. Dokter Sejuk AC melayani cuci AC, perbaikan AC, isi dan tambah freon, bongkar pasang, serta perawatan AC dengan teknisi berpengalaman, harga transparan, dan pengerjaan rapi."
        />
          ...
          <div className="container-page relative z-10">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-5 font-display text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
                Pertanyaan Seputar Service AC Kota Tangerang
              </h2>
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/85 sm:text-base lg:text-lg">
                ...
                wilayah service AC Dokter Sejuk AC di Kota Tangerang.
              </p>
            </div>

            {/* FAQ */}
            <div className="mx-auto mt-10 max-w-4xl space-y-4 sm:mt-12">
              {kotaTangerangFaq.map((item) => (
                <details
                  key={item.question}
