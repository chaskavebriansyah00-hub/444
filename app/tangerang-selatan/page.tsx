...
const pageUrl = `${siteUrl}/tangerang-selatan`;

const metaDescription =
  'Jasa service AC Tangerang Selatan profesional untuk rumah, apartemen, kantor, ruko, dan tempat usaha. Melayani cuci AC, perbaikan AC, isi dan tambah freon, bongkar pasang, serta perawatan AC dengan teknisi berpengalaman, harga transparan, dan garansi 30 hari.';

export const metadata: Metadata = {
  title:
    'Jasa Service AC Tangerang Selatan Profesional & Bergaransi | Dokter Sejuk AC',

  description: metaDescription,

  keywords: [
    'service AC Tangerang Selatan',
    'jasa service AC Tangerang Selatan',
    'cuci AC Tangerang Selatan',
    'isi freon Tangerang Selatan',
    'bongkar pasang AC Tangerang Selatan',
    'perbaikan AC Tangerang Selatan',
    'teknisi AC Tangerang Selatan',
    'Dokter Sejuk AC Tangerang Selatan',
  ],
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Teknisi Dokter Sejuk AC sedang service unit AC di Tangerang Selatan',
      },
    ],
  },
...
const localBusinessLd = {
  ...
  name: 'Dokter Sejuk AC — Service AC Tangerang Selatan',
  url: pageUrl,
...
const serviceLd = {
  ...
  serviceType: 'Service AC Tangerang Selatan',
  ...
  offers: {
    '@type': 'OfferCatalog',
    name: 'Layanan Service AC Tangerang Selatan',
...
const faqLd = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'Apakah Dokter Sejuk AC melayani service AC di Tangerang Selatan?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Tangerang Selatan dan sekitarnya.',
      },
    },
    {
      '@type': 'Question',
      name: 'Apa saja layanan service AC yang tersedia di Tangerang Selatan?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Apakah tersedia layanan cuci AC di Tangerang Selatan?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Ya. Dokter Sejuk AC melayani cuci AC untuk berbagai kebutuhan di Tangerang Selatan.',
      },
    },
    {
      '@type': 'Question',
    ...
    {
      '@type': 'Question',
      name: 'Wilayah Tangerang Selatan mana saja yang dilayani?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Kami melayani Ciputat, Ciputat Timur, Pamulang, Pondok Aren, Serpong, Serpong Utara, Setu, dan area sekitarnya.',
      },
    },
  ],
};
...
const breadcrumbLd = {
  ...
  itemListElement: [
    ...
    },
    {
      '@type': 'ListItem',
      position: 2,
      name: 'Service AC Tangerang Selatan',
      item: pageUrl,
    },
  ],
};

const tangerangSelatanFaq = [
  {
    question:
      'Apakah Dokter Sejuk AC melayani service AC di Tangerang Selatan?',
    answer:
      'Ya. Dokter Sejuk AC melayani service AC untuk rumah, apartemen, kantor, ruko, dan tempat usaha di wilayah Tangerang Selatan dan sekitarnya.',
  },
  {
    question:
      'Apa saja layanan service AC yang tersedia di Tangerang Selatan?',
    answer:
      'Cuci AC, isi dan tambah freon, perbaikan AC, AC tidak dingin, AC bocor, bongkar pasang, serta perawatan AC.',
  },
  {
    question: 'Apakah tersedia layanan cuci AC di Tangerang Selatan?',
    answer:
      'Ya. Dokter Sejuk AC melayani cuci AC untuk berbagai kebutuhan di Tangerang Selatan.',
  },
  {
  ...
  {
    question: 'Wilayah Tangerang Selatan mana saja yang dilayani?',
    answer:
      'Kami melayani Ciputat, Ciputat Timur, Pamulang, Pondok Aren, Serpong, Serpong Utara, Setu, dan area sekitarnya.',
  },
];
    ...
    <>
      ...
      <main>
        ...
        <AreaHero
          ...
          description="Jasa service AC Tangerang Selatan profesional untuk rumah, apartemen, kantor, ruko, dan tempat usaha. Dokter Sejuk AC melayani cuci AC, perbaikan AC, isi dan tambah freon, bongkar pasang, serta perawatan AC dengan teknisi berpengalaman, harga transparan, dan pengerjaan rapi."
        />
          ...
          <div className="container-page relative z-10">
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-5 font-display text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
                Pertanyaan Seputar Service AC Tangerang Selatan
              </h2>
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/85 sm:text-base lg:text-lg">
                ...
                wilayah service AC Dokter Sejuk AC di Tangerang Selatan.
              </p>
            </div>

            {/* FAQ */}
            <div className="mx-auto mt-10 max-w-4xl space-y-4 sm:mt-12">
              {tangerangSelatanFaq.map((item) => (
                <details
                  key={item.question}
