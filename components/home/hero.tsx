            ...
            <div className="grid items-center gap-8 lg:grid-cols-[1fr_1.05fr] lg:gap-4">
              ...
              <div className="relative z-20 max-w-2xl">
                ...
                >
                  ...
                  yang dapat memperbaiki AC Anda dengan cepat dan efektif.
                  Kami selalu memberikan pelayanan terbaik dengan harga
                  terjangkau untuk setiap pelanggan. Hubungi kami sekarang
                  untuk mendapatkan layanan jasa service AC terdekat yang
                  handal.
                </motion.p>
              </div>
