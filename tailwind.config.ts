  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'hero-glow':
          'radial-gradient(60% 60% at 20% 20%, hsl(211 100% 50% / 0.18) 0%, transparent 60%), radial-gradient(50% 50% at 85% 30%, hsl(160 84% 39% / 0.14) 0%, transparent 60%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      fontSize: {
        ...
        'display-xl': ['3rem', { lineHeight: '1.08', letterSpacing: '-0.025em', fontWeight: '700' }],
